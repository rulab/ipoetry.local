   ...
   public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->setMethod('POST')
            ->add('имя',TextType::class,array('attr' => array('maxlength' => 50,'required' => true)))//array('attr' => array('maxlength' => 50,'required' => true)))
            ->add('фамилия',TextType::class,array('attr' => array('maxlength' => 50,'required' => true)))
            ->add('почта', EmailType::class,array('attr' => array('maxlength' => 100,'required' => true)))
            ->add('пароль',TextType::class,array('attr' => array('maxlength' => 10,'required' => true)))

            //->add('captcha', $CaptchaType,array('attr' => array('required' => true,'disabled' => false)))
            ->add('Save', SubmitType::class, array('attr'=>array('class'=>'btn btn-lg btn-primary btn-block'),'label' => 'Зарегистрироваться'));
